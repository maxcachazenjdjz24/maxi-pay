 ...
 *
 * Adaptado de Conway-Research/automaton (MIT license). Se quitaron las
 * tareas por defecto ligadas a Conway (check_credits, check_usdc_balance,
 * check_social_inbox) — no aplican sin ese servidor de terceros.
 */
