...
/**
 * Interfaz mínima que necesita el motor de compresión — evita traer todo
 * el sistema multi-proveedor original (inference-client.ts); en nuestro
 * proyecto la usa el wrapper alrededor de inference/anthropic-client.ts.
 */
export interface CompressionInferenceClient {
  chat(params: {
    tier?: string;
    maxTokens: number;
    temperature?: number;
...
export class CompressionEngine {
  ...
  constructor(
    ...
    private readonly inference: CompressionInferenceClient,
  ) {}
